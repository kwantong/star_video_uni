	...
	<view class="container">
		<view class="page-body uni-content-info">
			...
			<view class='cropper-config'>
				<view class="cropper-choose" @click="getImage">选择图片</view>
				<view class="cropper-confirm" @click="getImageInfo">上传</view>
			</view>
				...
				uni.getImageInfo({
					...
					success: function success(res) {
						...
						if (IMG_RATIO >= 1) {
							...
							let cutL = Math.ceil((SCREEN_WIDTH * IMG_RATIO - cutHeight) / 2);
							let cutR = cutL;
							let cutT = Math.ceil((SCREEN_WIDTH - cutWidth) / 2);
							let cutB = cutT;
							_this.setData({
				...
				ctx.draw(true, () => {
					...
					uni.canvasToTempFilePath({
						...
						success: function (res) {
							...
							_this.$emit('uploadLoadCallBack',res.tempFilePath)
						}
					},_this);
